...
This experiment measures speed of evaluation CUDA FP model trained on EuParl
...
comet_ml.get_global_experiment().log_metric("quantization","none - FP")
comet_ml.get_global_experiment().log_metric("quan_specs","embeds in FP")
comet_ml.get_global_experiment().log_metric("device","CUDA")
