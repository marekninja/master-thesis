...
experiment_name = "FP train EuParl normal positiona_embeds_preserved"
...
training_args = {'output_dir': "/mnt/local/disk1/klasifikace_reflexe/MT_petrovic/in_progress/FP_marian_6",
...
pipe.trainer.save_model('./saved_models/trained/FP_marian_6_marianmt_v2_en-sk_euparl-openSubs_model_from_trainer')
