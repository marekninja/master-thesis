...
modelFP.model.save_pretrained('./saved_models/trained/FP_marian_2_marianmt_v2_en-sk_openSubs-euparl_model', push_to_hub=False)
modelFP.tokenizer.save_pretrained('./saved_models/trained/FP_marian_2_marianmt_v2_en-sk_openSubs-euparl_tokenizer',
                                  push_to_hub=False)

training_argsEval = {'no_cuda': False, 'fp16': False, 'per_device_eval_batch_size': eval_batch_size,
