...
Fine-Tune pre-trained Helsinki-NLP Marian model on EuParl
    1. Evaluate on Validation set
        1.1 EuroParl
        1.2 OpenSubs
    2. FineTune on EuroParl - LEARNING RATE IS 2e-3, THOUGH IT IS MORE LIKE THE CONTINUATION OF TRAINING...
...
training_args = {"save_strategy": "no",
                 ...
                 'learning_rate': 2e-3, 'per_device_train_batch_size': batch_size, 'warmup_steps': warmup_steps,
