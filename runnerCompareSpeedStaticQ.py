...
experiment_name = "SQ_CPU_EuParl measureSpeed"
...
pipe = Pipeline(Scenario.CALIBRATE, model=modelWrapped, dataset=calibration,
                training_args=training_argsCalibrate, metric_key_prefix="SQ_calib")
...
modelWrapped.quantizeStaticConvert(test_tr=True)
