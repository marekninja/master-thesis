...
experiment_name = "FP train EuParl inf reset2"
...
training_args = {'output_dir': "/mnt/local/disk1/klasifikace_reflexe/MT_petrovic/in_progress/FP_marian_INF2",
...
pipe.trainer.model_save('./saved_models/trained/FP_marian_INF2_marianmt_v2_en-sk_euparl-openSubs_model')

# modelQAT.model.save_pretrained('./saved_models/trained/FP_marian_INF2_marianmt_v2_en-sk_euparl-openSubs_model',
#                                push_to_hub=False)
# modelQAT.tokenizer.save_pretrained('./saved_models/trained/FP_marian_INF2_marianmt_v2_en-sk_euparl-openSubs_tokenizer',
#                                    push_to_hub=False)
