...
warmup_steps = 2000
max_steps = 5000# 250k update steps maximum, overides train_epochs...
save_total_limit = 50
bn_freeze = int(
...
experiment_name = "FP train EuParl small reset2"
...
training_args = {#'output_dir': "/mnt/local/disk1/klasifikace_reflexe/MT_petrovic/in_progress/FP_marian_4",
...
# pipe.trainer.save_model('./saved_models/trained/FP_marian_4_marianmt_v2_en-sk_euparl-openSubs_model_from_trainer')
pipe.trainer.save_model('./saved_models/trained/reset2_marian_model_from_trainer')
