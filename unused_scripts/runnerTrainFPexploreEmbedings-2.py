...
experiment_name = "FP train EuParl normal positional_embeds SINreseted"
...
saved_model_dir = './saved_models/trained/FP_marian_EmbedsExploreSinusoid_marianmt_v2_en-sk_euparl-openSubs_model_from_trainer'
pipe.trainer.save_model(saved_model_dir)
...
experiment_name = "QAfineTune EmbedingsAnomaly SIN"
...
experiment_name = "FPfineTune EmbedingsAnomaly SIN"
